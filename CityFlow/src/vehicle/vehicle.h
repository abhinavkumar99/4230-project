...
namespace CityFlow {
    ...
    public:
        ...
        void setTurnSoon(bool val) { buffer.turnSoon = val; }
        ...
        bool getTurnSoon() const { return buffer.turnSoon; }
        ...
        inline std::string getVehicleType() const { return vehicleInfo.vehicleType; }
